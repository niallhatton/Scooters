...
**Navigation**: The navigation bar uses Bootstrap 4 features, responsiveness and includes the custom logo designed for the company. The navigation bar has been used on all pages and is consistant across the site.
